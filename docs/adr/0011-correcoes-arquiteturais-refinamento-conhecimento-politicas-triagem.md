...
2.  **Limpeza e Enriquecimento do Conhecimento (Base de Dados/JSON)**:
    *   Adicionar seções completas para: Política de Cancelamento e Regras Climáticas. *(A gestão dos pacotes ofertados será tratada conforme a ADR-0012).*
